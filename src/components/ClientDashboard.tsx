...
export default function ClientDashboard({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Grid of Industrial Equipment Statuses */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {/* --- Lift Failure Request Ticket Form --- */}
        <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-xs h-fit space-y-4 text-left">
          ...
          <form onSubmit={handleRequestCorrective} className="space-y-3 text-xs">
            <div>
              ...
              <select
                ...
                className="w-full px-2 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none"
              >
            ...
            <button
              type="submit"
              className="w-full py-2 bg-[#282829] hover:bg-slate-800 text-white font-bold text-xs rounded-lg transition-colors cursor-pointer text-center"
            >
