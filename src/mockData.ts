...
export const INITIAL_CATALOG_ITEMS: CatalogItem[] = [
  // --- EQUIPOS ---
  {
    id: 'cat_eq_1',
    type: 'equipment',
    itemCode: 'EQ-KAE-AS30T',
    nameOrModel: 'Kaeser AS 30 T',
    description: 'Compresor de tornillo rotativo con secador integrado refrigerativo, control Sigma Control Basic.',
    brand: 'Kaeser',
    category: 'Compresores de Tornillo',
    price: 18500,
    currency: 'USD',
    stock: 2,
    minStock: 1,
    ...
    clientName: 'ANDREA',
    serialNumber: '1030',
    capacity: '30 HP / 22 kW - 120 CFM @ 110 PSI',
    voltage: '440V 3F 60Hz',
    location: 'Patio Central - Bahía A',
    deliveryTime: 'Inmediata (Stock)',
    isActive: true,
    notes: 'Equipo verificado en banco de pruebas con horómetro en 0 hrs.',
    createdAt: '2026-06-25T10:00:00Z'
  },
  {
    id: 'cat_eq_2',
    type: 'equipment',
    itemCode: 'EQ-KAE-BSD50',
    nameOrModel: 'Kaeser BSD 50',
    description: 'Compresor industrial de tornillo de velocidad fija para servicio continuo 24/7.',
    brand: 'Kaeser',
    category: 'Compresores de Tornillo',
    price: 24500,
    currency: 'USD',
    ...
    unit: 'equipo',
    clientName: 'Grupo Industrial Monterrey',
    serialNumber: 'KAE-BSD50-8841',
    capacity: '50 HP / 37 kW - 215 CFM @ 125 PSI',
    voltage: '440V 3F 60Hz',
    location: 'Almacén León - Bahía B',
    deliveryTime: 'Inmediata (Stock)',
    isActive: true,
    notes: 'Mantenimiento preventivo reciente y filtros nuevos instalados.',
    createdAt: '2026-07-01T12:00:00Z'
  },
  {
    id: 'cat_eq_3',
    type: 'equipment',
    itemCode: 'EQ-AC-GA18P',
    nameOrModel: 'Atlas Copco GA 18 Pack',
    description: 'Compresor rotativo de tornillo lubricado con inyección de aceite y controlador Elektronikon.',
    brand: 'Atlas Copco',
    category: 'Compresores de Tornillo',
    price: 16200,
    currency: 'USD',
    ...
    unit: 'equipo',
    clientName: 'Isocindu',
    serialNumber: 'CAI 847490',
    capacity: '25 HP / 18.5 kW - 105 CFM @ 125 PSI',
    voltage: '440V 3F 60Hz',
    location: 'Almacén León - Bahía C',
    deliveryTime: 'Inmediata (Stock)',
    isActive: true,
    notes: 'Unidad compacta de alto rendimiento acústico encapsulado.',
  ...
  },
  {
    ...
    type: 'equipment',
    itemCode: 'EQ-SUL-S45',
    nameOrModel: 'Sullair S-Energy 4509',
    description: 'Compresor encapsulado silencioso con lubricación Sullube y válvula WSCS.',
    brand: 'Sullair',
    category: 'Compresores de Tornillo',
    price: 26800,
    currency: 'USD',
    ...
    serialNumber: 'SUL-2026-0044',
    capacity: '60 HP / 45 kW - 260 CFM @ 125 PSI',
    voltage: '440V 3F 60Hz',
    location: 'Almacén Matriz',
    deliveryTime: 'Inmediata (Stock)',
    isActive: true,
    notes: 'Disponible para cotización a cualquier cliente industrial.',
    createdAt: '2026-08-01T11:15:00Z'
  },
  {
    id: 'cat_eq_5',
    type: 'equipment',
    itemCode: 'EQ-KAE-TB19',
    nameOrModel: 'Secador Kaeser Secotec TB 19',
    description: 'Secador refrigerativo con masa térmica de ahorro energético para punto de rocío de 3°C.',
    brand: 'Kaeser',
    category: 'Secadores Refrigerativos',
    price: 6800,
    currency: 'USD',
    stock: 2,
    minStock: 1,
    unit: 'equipo',
    clientName: 'General / Todos',
    serialNumber: 'TB19-2026-012',
    capacity: '130 CFM @ 100 PSI',
    voltage: '220V 1F 60Hz',
    location: 'Almacén Silao',
    deliveryTime: 'Inmediata (Stock)',
    isActive: true,
    notes: 'Purga electrónica ECO-DRAIN incluida.',
  ...
  // --- REFACCIONES ---
  {
    ...
    type: 'part',
    itemCode: '6.2000.0',
    nameOrModel: 'Filtro de Aire OEM Kaeser',
    description: 'Filtro de aire para admisión de compresor Kaeser AS 30 T / SK / SX (Ref OEM KC160-017).',
    brand: 'Kaeser',
    ...
    unit: 'pza',
    clientName: 'ANDREA',
    equipmentModel: 'AS 30 T',
    location: 'Almacén Central - Rack F1',
    deliveryTime: 'Inmediata (Stock)',
    isActive: true,
    notes: 'Compatible con serie AS 30 T y modelos similares.',
    createdAt: '2026-06-25T10:00:00Z'
  },
  {
    id: 'cat_part_2',
    type: 'part',
    itemCode: '6.1985.0',
    nameOrModel: 'Filtro de Aceite OEM Kaeser',
    description: 'Cartucho de filtro de aceite roscado Spin-On (Ref OEM KL320-014).',
    brand: 'Kaeser',
    ...
    clientName: 'ANDREA',
    equipmentModel: 'AS 30 T',
    location: 'Almacén Central - Rack F2',
    deliveryTime: 'Inmediata (Stock)',
    isActive: true,
    notes: 'Resiste presiones de hasta 20 bar.',
    createdAt: '2026-06-25T10:00:00Z'
  },
  {
    id: 'cat_part_3',
    type: 'part',
    itemCode: '6.1963.0',
    nameOrModel: 'Filtro Separador Aire/Aceite Kaeser',
    description: 'Separador coalescente Spin-On con conexión a tierra antiestática (Ref OEM MV110-003).',
    brand: 'Kaeser',
    ...
    clientName: 'ANDREA',
    equipmentModel: 'AS 30 T',
    location: 'Almacén Central - Rack S1',
    deliveryTime: 'Inmediata (Stock)',
    isActive: true,
    notes: 'Mantiene arrastre de aceite residual menor a 3 ppm.',
    createdAt: '2026-06-25T10:00:00Z'
  },
  {
    id: 'cat_part_4',
    type: 'part',
    itemCode: '4.7333.0',
    nameOrModel: 'Válvula de Presión Mínima (MPV)',
    description: 'Kit de mantenimiento con resorte, asiento y oring para válvula check MPV.',
    brand: 'Kaeser',
    category: 'Válvulas',
    price: 1850.00,
    currency: 'USD',
    ...
    clientName: 'ANDREA',
    equipmentModel: 'AS 30 T',
    location: 'Almacén Silao - Gaveta V3',
    deliveryTime: 'Inmediata (Stock)',
    isActive: true,
    notes: 'Calibración de fábrica a 4.5 bar.',
    createdAt: '2026-06-25T10:00:00Z'
  },
  {
    id: 'cat_part_5',
    type: 'part',
    itemCode: '7.0399.0',
    nameOrModel: 'Kit de Válvula Termostática',
    description: 'Termoelemento regulador de temperatura a 71°C para circuito de refrigerante/aceite.',
    brand: 'Kaeser',
    category: 'Válvulas',
    price: 2100.00,
    currency: 'USD',
    ...
    clientName: 'ANDREA',
    equipmentModel: 'AS 30 T',
    location: 'Almacén Silao - Gaveta V4',
    deliveryTime: 'Inmediata (Stock)',
    isActive: true,
    notes: 'Evita condensación de agua en el depósito separador.',
    createdAt: '2026-06-25T10:00:00Z'
  },
  {
    id: 'cat_part_6',
    type: 'part',
    itemCode: 'KAOA467C-05',
    nameOrModel: 'Aceite Sintético Grado Compresor (40L)',
    description: 'Lubricante sintético PAO grado compresor Sigma Fluid S-460 para hasta 8,000 horas de servicio.',
    brand: 'Kaeser',
    ...
    clientName: 'ANDREA',
    equipmentModel: 'AS 30 T',
    location: 'Almacén Químicos - Estiba 2',
    deliveryTime: 'Inmediata (Stock)',
    isActive: true,
    notes: 'Aprobado para servicio pesado en plantas de manufactura.',
    createdAt: '2026-06-25T10:00:00Z'
  },
  {
    id: 'cat_part_7',
    type: 'part',
    itemCode: '2903 7526 00',
    nameOrModel: 'Filtro de Aceite Atlas Copco',
    description: 'Cartucho filtrante original para compresores de tornillo GA 18 / GA 22 Pack.',
    brand: 'Atlas Copco',
    category: 'Filtros de Aceite',
    price: 77.16,
    currency: 'USD',
    ...
    unit: 'pza',
    clientName: 'Isocindu',
    equipmentModel: 'GA 18 Pack',
    location: 'Almacén León - Rack AC1',
    deliveryTime: 'Inmediata (Stock)',
    isActive: true,
    notes: 'Original de fábrica Atlas Copco.',
    createdAt: '2026-07-15T09:30:00Z'
  },
  {
    id: 'cat_part_8',
    type: 'part',
    itemCode: '1613 8720 00',
    nameOrModel: 'Filtro de Aire Atlas Copco Heavy Duty',
    description: 'Elemento filtrante de aire cilíndrico de alta retención para partículas metálicas y polvo.',
    brand: 'Atlas Copco',
    category: 'Filtros de Aire',
    price: 95.50,
    currency: 'USD',
    ...
    clientName: 'Isocindu',
    equipmentModel: 'GA 18 Pack',
    location: 'Almacén León - Rack AC2',
    deliveryTime: 'Inmediata (Stock)',
    isActive: true,
    notes: 'Compatible con GA 15, GA 18 y GA 22.',
    createdAt: '2026-07-15T09:30:00Z'
  },
  {
    id: 'cat_part_9',
    type: 'part',
    itemCode: '2901 0774 00',
    nameOrModel: 'Kit de Válvula de Admisión Unloader',
    description: 'Juego de sellos, pistón y resorte para válvula de carga/descarga Atlas Copco.',
    brand: 'Atlas Copco',
    category: 'Válvulas',
    price: 340.00,
    currency: 'USD',
    ...
    clientName: 'Isocindu',
    equipmentModel: 'GA 18 Pack',
    location: 'Almacén León - Gaveta AC-V1',
    deliveryTime: 'Inmediata (Stock)',
    isActive: true,
    notes: 'Recomendado cambiar cada 8,000 hrs de trabajo.',
    createdAt: '2026-07-15T09:30:00Z'
  },
  {
    id: 'cat_part_10',
    type: 'part',
    itemCode: '02250155-709',
    nameOrModel: 'Filtro Óptimo Sullair S-Energy',
    description: 'Elemento de admisión de aire con nanofibras para compresores Sullair 45-75 kW.',
    brand: 'Sullair',
    category: 'Filtros de Aire',
    price: 185.00,
    currency: 'USD',
    ...
    unit: 'pza',
    clientName: 'General / Todos',
    equipmentModel: 'S-Energy 4509',
    location: 'Almacén Matriz - Rack SULL',
    deliveryTime: 'Inmediata (Stock)',
    isActive: true,
    notes: 'Garantiza 99.9% de eficiencia en partículas submicrónicas.',
    createdAt: '2026-08-01T11:15:00Z'
  },
  {
    id: 'cat_part_11',
    type: 'part',
    itemCode: 'DESC-OLD-01',
    nameOrModel: 'Sensor de Presión Descatalogado Kaeser Modelo Antiguo',
    description: 'Transductor de presión analógico 4-20mA 0-16 bar versión descatalogada.',
    brand: 'Kaeser',
    ...
    unit: 'pza',
    clientName: 'General / Todos',
    equipmentModel: 'Modelos Antiguos 1998-2005',
    location: 'Almacén Archivo',
    deliveryTime: 'Descontinuado (Verificar sustituto)',
    isActive: false, // Desactivado para probar la función de activar/desactivar!
    notes: 'Registro desactivado por descontinuación del fabricante. Conservado para historial.',
